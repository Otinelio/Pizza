...
export default function ContactPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--color-bg)" }}>
      ...
      <section style={{ padding: "0 32px 40px", maxWidth: 900, margin: "0 auto", display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center" }}>
      ...
      <section style={{ padding: "0 32px 40px", maxWidth: 900, margin: "0 auto", display: "flex", gap: 16, justifyContent: "center" }}>
