...
export default function AboutPage() {
  return (
    <div style={{ minHeight: "100vh", background: "var(--color-bg)" }}>
      <section style={{ padding: "100px 32px 60px", maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        <Reveal>
      ...
      <section style={{ padding: "0 32px 60px", maxWidth: 700, margin: "0 auto" }}>
        <Reveal>
      ...
      <section style={{ padding: "40px 32px 100px", maxWidth: 700, margin: "0 auto", textAlign: "center" }}>
        <Reveal>
